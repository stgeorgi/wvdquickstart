...
param(
	...
	[Parameter(mandatory = $false)]
	[string] $LimitSecondsToForceLogOffUser,
...
try {
	...
	if ($WebHookData) {
		Write-Output 'Runbook was started from Webhook'
	...
	Write-Output "Used parameters are:"
	Write-Output (@{
		...
		}.GetEnumerator() | Sort-Object -Property 'Key' | Out-String) 
